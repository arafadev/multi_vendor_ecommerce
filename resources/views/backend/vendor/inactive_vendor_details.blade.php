...
@section('title', 'Inactive Vendors Details')
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="id" value="{{ $inactiveVendorDetails->id }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" id="inputAddress2" placeholder="Vendor Info " rows="3" disabled>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                ...
                                                alt="Vendor" style="width:100px; height: 100px;" disabled   >
                                        </div>
                                    </div>
                                    <div class="row">
